...
<div align="center">
  <a href="https://github.com/github_username/repo_name">
    <img src="images/Octocat.png" alt="Logo" width="150">
  </a>
...
<kbd><img src="images/1.png" style="border:10px solid black" alt="error" width="900" ></kbd><br>
...
<kbd><img src="images/2.png" style="border:10px solid black" alt="error" width="900" ></kbd><br>

<p>3. The issue should now be resolved and you should be able to run the commands on your shell.</p>
<kbd><img src="images/3.png" style="border:10px solid black" alt="error" width="900" ></kbd><br>
